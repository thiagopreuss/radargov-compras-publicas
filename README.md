...
O primeiro processo (`coletar_contratacoes_consulta_v2.py`) consulta o PNCP e coleta as contratações correspondentes ao recorte definido de estado, período e modalidades.
...
![Visão Geral do Mercado](Power%20BI/Imagens/RadarGov%20-%20Visão%20Geral.png)
